...
import '../pulsular_loader.dart';

class AnimatedCatCard extends StatelessWidget {
                ...
                child: ClipRRect(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        bottom: cardHeight > threshold ? 16 : 5,
                        left: cardHeight > threshold ? 16 : 5,
                        child: Column(
